...
def main(page: ft.Page):
    ...
    if os.path.exists(f"{desktop_path}\\PDF") == False or os.path.exists(f"{desktop_path}\\TABELAS") == False:
        os.makedirs(f"{desktop_path}\\PDF")
        os.makedirs(f"{desktop_path}\\TABELAS")
    ...
    def salvar_pdf(mes,ano,pesquisa):
        ...
        try:
            ...
            caminho_pasta = f"{desktop_path}\\PDF"
